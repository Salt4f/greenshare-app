...
{
    public class OutgoingAcceptedViewModel : BaseViewModel
    {
        ...
        private async void OnStart(object sender, EventArgs args)
        {
            try
            {
                ...
                acceptedInteractions = await OfferRequestInteraction.Instance().GetAcceptedPosts("outgoing", navigation, view);
